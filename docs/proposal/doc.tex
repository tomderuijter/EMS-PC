...
Research has also been done on inferring effective connectivity, based on Granger causality (Roebroeck, Formisano, Goebel, 2005), multivariate autoregressive modeling (Harrison, Penny, Friston, 2003) and dynamic causal modelling (Friston, Harrison, Penny, 2003).
However, many challenges are still being faced. (Ramsey, Hanson, Hanson, Halchenko, Poldrack , Glymour)
