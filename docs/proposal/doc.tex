...
One type of connectivity analysis involves finding causal relations between brain areas.
...
%Research has also been done on inferring effective connectivity, based on Granger causality \cite{Roebroeck2005}, multivariate autoregressive modeling \cite{Harrison2003} and dynamic causal modelling \cite{Friston2003}.
