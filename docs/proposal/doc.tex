...
This is strongly related with functional connectivity: regions can only be functionally connected if there is a physical connection between them. \cite{vandenheuvel2009}
