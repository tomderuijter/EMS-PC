...
One type of connectivity analysis involves in determining these causal relations between brain areas.
However, causal analysis still faces many challenges that require solutions \cite{ramsey2010}.
