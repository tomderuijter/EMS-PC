...
The causal discovery method which we will use is the BCCD-algorithm.
This algorithm finds both the structure of a network as well as the direction of the connections of this network. This algorithm has some useful properties; it is a Bayesian approach and as such, it is robust against noise.
...
Concretely, this provides an uncertainty measure over edges in the network, giving additional information compared to PC and FCI \cite{claassen2012}.
