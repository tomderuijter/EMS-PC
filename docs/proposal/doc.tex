...
Today, the secrets of our brains still belong to the most sought-after secrets.
...
We have come a long way since the time of Phrenology, the pseudoscience based on the idea that cognitive ability and personality could be derived from measurements of the skull.
...
Brain connectivity also finds applications in medicine.
...
This gives an insight in the organization of the brain, even though the exact functioning is still unclear \cite{Lowe2000, doria2010, Bullmore2009}.
...
The causal discovery method which we will use is the PC-algorithm (spirtes, 2000). An advantage of this algorithm is that the scaling is relatively well. 
