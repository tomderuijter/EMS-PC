...
The causal discovery method which we will use is the BCCD-algorithm. This algorithm finds both the structure of a network as well as the direction of the connections of this network. An advantage of this algorithm is that the scaling is relatively good. BCCD also finds probabilities of connections.
