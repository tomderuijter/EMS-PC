...
The structure of a network can also be given as input, for which the PC-algorithm can determine the directions.
...
These results will  be evaluated by cross-subject comparison, to see whether the gained data is consistent.
