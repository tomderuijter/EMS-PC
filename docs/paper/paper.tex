...
%TODO: pseudocode nodig? of een verwijzing naar het boek (die pseudocode is wat onduidelijk)?

\usepackage{algorithmic}

%\begin{algorithm}[PC-algorithm]
\STATE Starting state of undirected graph G: connect all pairs of points. Set n = 0.
\WHILE{there are connected pairs $X$, $Y$ such that |Adjecencies(G,X)\{Y}| < } 
