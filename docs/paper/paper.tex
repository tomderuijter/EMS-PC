...
% TODO: There was a lot (!) of pre-processing conducted after the data was collected. You should emphasize this and refer the reader to the original article so look these things up, if desired.
...
The connections between the homologuous areas are clearly visible as two diagonal lines.
...
A notable difference between modified PC and EMS-PC is that the assymetric arrowheads of the PDAG are about twice as high. %TODO: histogram
