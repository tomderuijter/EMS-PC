...
One notable difference between the results found in Hinne et al. are the strong connections between homological areas, visible as two diagonal lines.
...
These connections most likely correspond to the corpus callosum.
