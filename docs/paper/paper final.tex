...
%Existing problems with current methods and applications, specifically [Tom: mention all, or just the relevant problems?][Ramon: de relevante nu benoemd]
%- Model selection
...
%TODO nog meer previous research over causal discovery? Bayesian approaches?
...
%- When would EMS-PC perform better than PC algorithm regarding directionality results? [Ramon: lijkt me meer iets voor validation]
...
All measurements and pre-processing as described in this section has been done during previous research. Noadditional pre-processing was needed in our research in order to apply the PC algorithm on this data.
...
As can be seen in figures~\ref{fig:assym_subjects} and~\ref{fig:assym_avg}, the certainties of one-directional arrows are very low compared to the certainties of the bi-directional arrows. Also, the certainties of one-directional arrows are somewhat higher in EMS-PC than in standard PC.
