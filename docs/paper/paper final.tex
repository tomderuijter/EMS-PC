...
The consistency can also be seen in the distribution of values in figure~\ref{distributions}.
...
As can be seen in the distribution of values in figure~\ref{distributions}, nearly all found edges are oriented as bi-directional arrows.
