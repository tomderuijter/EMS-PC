...
\usepackage{cite}
%\usepackage{anysize} <- this makes the article much wider
\usepackage{setspace}
...
\begin{minipage}[t]{1.2\textwidth}
  ...
  \includegraphics[height=0.29\textheight]{images/new/struct_subj2_colorbar-crop} % one colorbar at the top right of the figure
