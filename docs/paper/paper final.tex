...
In functional MRI-measurements, the delay between brain activity and the indirect measurement of that activity is unknown. %TODO moest MRI nou helemaal uitgeschreven of niet? Ik vind zelf van niet.
...
\begin{figure}[h!]
  \centering
  \includegraphics[height=0.28\textwidth]{images/new/struct_subj1-crop} % TODO remove colorbar, why is it even there
