...
From this data, covariance between regions can be determined, so that regions can be tested for \textit{d}-separation with the Fisher's conditional independence test.
