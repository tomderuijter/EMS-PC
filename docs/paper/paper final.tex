...
% Implementation
We have implemented standard PC and EMS-PC in Matlab using the Bayesian Network Toolbox for Matlab.
% TODO: Finish this.
...
%Markov equivalence class size (nr. of latent variables / bidirectional arrows) within subjects and Markov class Asymmetry
...
The results are presented per subject in Figure~\ref{} and as an avarage across all subjects iin Figure ~\ref{fig:struct_avg}. %TODO figure fixen per subjects
